...
# Cargar los archivos
df_wos = pd.read_excel('C:\\Investigación\\Trabajo_2023\Codificaciones\\universidadespublicasfinales.xlsx')
...
standard_name = 'UNIVERSIDAD INTERNACIONAL SEK'
...
df_wos.to_excel('C:\\Investigación\\Trabajo_2023\Codificaciones\\universidadespublicasfinalesinternacionalsek.xlsx', index=False)
