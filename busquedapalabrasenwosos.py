...
valores = ['Computer Science', 'Information Science', 'Technology', 'computacion de ciencias']
...
palabras = ['web application', 'website', 'evaluation', 'evaluate']
...
# df_filtrado.to_excel('dframeresultado.xlsx', index=False)
